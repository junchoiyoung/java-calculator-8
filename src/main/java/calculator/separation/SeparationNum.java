...
public class SeparationNum {
    public static String[] separateNum(String str, ArrayList<String> separatorList) {
        //예외처리(맨앞이나 뒤에 구분자가 있는지)
        ExceptionChecker.checkSeparatorPosition(str);
        ...
        //예외처리(구분자가 2번 연속으로 나오는지)
        ExceptionChecker.checkContinuousSeparator(str);
